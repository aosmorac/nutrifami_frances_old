/*global angular*/
nutrifamiApp.controller('UnidadController', ['$scope', '$location', '$routeParams', '$anchorScroll', 'ngAudio', 'bsLoadingOverlayService', '$timeout', function ($scope, $location, $routeParams, $anchorScroll, ngAudio, bsLoadingOverlayService, $timeout) {
        'use strict';
        $anchorScroll();
